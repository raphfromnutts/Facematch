...
<html>
    <head>
        ...
        <title>FaceMatch - Classement Boy (filtré par nom ou classe)</title>
    ...
    <body>
        ...
        <p class="choix" style="display:block; text-align:center; margin-top:32px; margin-bottom:10px; line-height:25px;">Clique pour choisir :<br><a href="rankingboy.php" style="color:black; text-decoration:none; font-weight:bold;">Classement Boy</a> - <a href="rankinggirl.php" style="color:black; text-decoration:none;">Classement Girl</a></p>
        ...
        $query = 'SELECT @rang:=@rang+1 AS classement, token, name, path, score, class FROM rankboy, (SELECT @rang:=0) tmp';
