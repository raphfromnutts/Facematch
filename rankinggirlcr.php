...
<html>
    <head>
        ...
        <title>FaceMatch - Classement Girl (score croissant)</title>
        ...
        $(window).scroll(function(){
          ...
          if($(window).scrollTop() == $(document).height() - $(window).height()){
            ...
            $.ajax({
              ...
              url : "loadgirlcr.php?lastid=" + $(".item:last").attr("id"),
    ...
    <body>
        ...
        <p style="display:block; text-align:center; margin-bottom:10px; margin-top:32px; line-height:25px;">Clique pour choisir :<br><a href="rankingboy.php" style="color:black; text-decoration:none;">Classement Boy</a> - <a href="rankinggirl.php" style="color:black; text-decoration:none; font-weight:bold;">Classement Girl</a></p>
        ...
        <p id="option3" style="display:none; text-align:center;  line-height:25px;">ORDRE <a href="#" style="color:black; text-decoration:none; font-weight:bold;">CROISSANT</a> / <a href="rankinggirl.php" style="color:black; text-decoration:none;">DÉCROISSANT</a></p>
        <table>
          <tr>
