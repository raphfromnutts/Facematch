...
<html>
    ...
    <head>
        ...
        <title>FaceMatch - Classement Boy</title>
        ...
        $(window).scroll(function(){
          ...
          if($(window).scrollTop() == $(document).height() - $(window).height()){
            ...
            $.ajax({
              ...
              url : "loadboy.php?lastid=" + $(".item:last").attr("id"),
    ...
    <body>
        ...
        <p class="choix" style="display:block; text-align:center; margin-top:32px; margin-bottom:10px; line-height:25px;">Clique pour choisir :<br><a href="#" style="color:black; text-decoration:none; font-weight:bold;">Classement Boy</a> - <a href="rankinggirl.php" style="color:black; text-decoration:none;">Classement Girl</a></p>
        ...
        <p id="option3" style="display:none; text-align:center;  line-height:25px;">ORDRE <a href="rankingboycr.php" style="color:black; text-decoration:none;">CROISSANT</a> / <a href="#" style="color:black; text-decoration:none; font-weight:bold;">DÉCROISSANT</a></p>
        ...
        $query = 'SELECT @rang:=@rang+1 AS classement, token, name, path, score, class FROM rankboy, (SELECT @rang:=0) tmp LIMIT 0, 10';
